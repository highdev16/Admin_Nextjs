    ...
    APICall(
      ...
      (data) => {
        setAgentInfo({
          ...
          upstream_agent_code: data.upstream_agent_code,
          note: data.note,
      ...
      (e) => {
        if (e[0] == 'login_issue') {
          ...
          window.location.href = '/auth/login';
        } else alert(e[1] || 'Error occurred. Try again');
      },
    );
  }, []);
      ...
      <Row style={{ marginLeft: 0, marginRight: 0 }}>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-blue">
            <div className="white-title">Agent Information</div>
            <div className="tabs">
                ...
                <Col breakPoint={{ xs: 3 }}>
                  <div className="form-item">
                    ...
                    <div className="form-value">
                      <select>
                        <option value={agentInfo.agent_level}>{agentInfo.agent_level}</option>
                      </select>
                    </div>
                  </div>
                </Col>
                  ...
                  <div className="form-item">
                    ...
                    <div className="form-value">
                      <input
                        ...
                        onChange={(e) => setAgentInfo((p) => ({ ...p, phone_number: e.target.value }))}
                      />
                    </div>
                  </div>
                </Col>
                  ...
                  <div className="form-item">
                    ...
                    <div className="form-value">
                      <input
                        type="text"
                        id="note"
                        value={agentInfo.note}
                        onChange={(e) => setAgentInfo((p) => ({ ...p, note: e.target.value }))}
                      ></input>
                    </div>
                  </div>
                </Col>
