          ...
          <table id="contentTableObj">
            <tbody id="contentTable">
              <tr>
                ...
                <td colSpan={4} style={{ width: '20%', borderBottom: '1px solid black' }}>
                  First Half
                </td>
              </tr>
              <tr>
                <td>1</td>
                <td style={{ borderLeft: '1px solid black' }}>X</td>
                <td style={{ borderLeft: '1px solid black' }}>2</td>
                <td style={{ borderLeft: '1px solid black', borderRight: '1px solid black' }}>1X2 Total</td>
                <td>1</td>
                <td style={{ borderLeft: '1px solid black' }}>X</td>
                <td style={{ borderLeft: '1px solid black' }}>2</td>
                <td style={{ borderLeft: '1px solid black' }}>1X2 Total</td>
              </tr>
            </tbody>
          </table>
