  ...
  const createAccount = () => {
    ...
    APICall(
      ...
      (e) => {
        ...
        document.getElementById('agent_level').value = 'SSMA';
      ...
      (e) => {
        ...
        else alert(e[1] || 'Failed to create the new SSMA');
      },
    );
  };
      ...
      <Row>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-white">
            <div className="blue-title">New SSMA</div>
          </div>
                          ...
                          <tr>
                            ...
                            <td style={{ width: '16%', height: '40px' }}>
                              <select style={{ width: '100%' }} id="agent_level">
                                <option value="SSMA">Senior Super Master Agent</option>
                              </select>
                            </td>
                            <td style={{ width: '16%' }} />
                            <td style={{ width: '16%' }} />
