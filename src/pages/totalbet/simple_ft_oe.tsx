      ...
      <Row style={{ marginLeft: 0, marginRight: 0 }}>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-blue">
            <div className="white-title">Simple FT OE</div>
          ...
          <table id="contentTableObj">
            <tbody id="contentTable">
              <tr>
                ...
                <td style={{ width: '20%', borderLeft: '1px solid black', borderRight: '1px solid black' }}>Teams</td>
                <td style={{ width: '20%', borderRight: '1px solid black' }}>Odds</td>
                <td style={{ width: '20%', borderRight: '1px solid black' }}>OU Total</td>
                <td style={{ width: '20%' }}>Odd Even Total</td>
              </tr>
            </tbody>
          </table>
