      ...
      <Row>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-blue">
            <div className="white-title">Simple HT HDP & OU</div>
          ...
          <table id="contentTableObj">
            <tbody id="contentTable">
              <tr>
                ...
                <td style={{ width: '35%', borderLeft: '1px solid black', borderRight: '1px solid black' }}>Teams</td>
                <td style={{ width: '20%', borderRight: '1px solid black' }}>HDP total</td>
                <td style={{ width: '20%' }}>OU total</td>
              </tr>
            </tbody>
          </table>
