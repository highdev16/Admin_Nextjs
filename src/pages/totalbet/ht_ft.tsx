      ...
      <Row>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-blue">
            <div className="white-title">HT/FT</div>
          ...
          <table id="contentTableObj">
            <tbody id="contentTable">
              <tr>
                ...
                <td style={{ width: '15%', borderLeft: '1px solid black' }}>Best List</td>
                <td style={{ width: '5%', borderLeft: '1px solid black' }}>HH</td>
                <td style={{ width: '5%', borderLeft: '1px solid black' }}>HD</td>
                <td style={{ width: '5%', borderLeft: '1px solid black' }}>HA</td>
                <td style={{ width: '5%', borderLeft: '1px solid black' }}>DH</td>
                <td style={{ width: '6%', borderLeft: '1px solid black' }}>DD</td>
                <td style={{ width: '6%', borderLeft: '1px solid black' }}>DA</td>
                <td style={{ width: '6%', borderLeft: '1px solid black' }}>AH</td>
                <td style={{ width: '6%', borderLeft: '1px solid black' }}>AD</td>
                <td style={{ width: '6%', borderLeft: '1px solid black' }}>AA</td>
              </tr>
            </tbody>
          </table>
