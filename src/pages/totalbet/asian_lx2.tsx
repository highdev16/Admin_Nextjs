      ...
      <Row>
        <Col className="centerAll" breakPoint={{ xs: 12, md: 12 }}>
          ...
          <div className="header-blue">
            <div className="white-title">Asian LX2</div>
          ...
          <table id="contentTableObj">
            <tbody id="contentTable">
              ...
              <tr>
                <td>1</td>
                <td style={{ borderLeft: '1px solid black', borderRight: '1px solid black' }}>X</td>
                <td>2</td>
                <td style={{ borderLeft: '1px solid black' }}>Best List</td>
                <td style={{ borderLeft: '1px solid black' }}>1</td>
                <td style={{ borderLeft: '1px solid black', borderRight: '1px solid black' }}>X</td>
                <td>2</td>
                <td style={{ borderLeft: '1px solid black' }}>Best List</td>
              </tr>
